...
public interface DogRepository extends JpaRepository<DogEntity, Integer> {
        ...
        List<DogEntity> lifeStyleRef(int size, int apartmentLiving, int noviceOwners, int beingAlone,
                        int amountOfShedding);
        ...
        List<DogEntity> dogStyle(int size, int apartmentLiving, int noviceOwners, int dogFriendly, int strangers,
                        int family, int amountOfShedding, int easyToGroom, int easyToTrain, int intelligence,
                        int barkOrHowl,
        ...
        List<DogEntity> dogStyle(int size, int apartmentLiving, int noviceOwners, int strangers, int family,
                        int amountOfShedding, int easyToGroom, int easyToTrain, int intelligence, int barkOrHowl,
                        int wanderlust,
        ...
        List<DogEntity> dogStyle(int size, int apartmentLiving, int noviceOwners, int family, int amountOfShedding,
                        int easyToGroom, int easyToTrain, int intelligence, int barkOrHowl, int wanderlust,
                        int energyLevel,
                        int playfullness);
        ...
        List<DogEntity> dogStyle(int size, int apartmentLiving, int noviceOwners, int amountOfShedding, int easyToGroom,
                        int easyToTrain, int intelligence, int barkOrHowl, int wanderlust, int energyLevel,
                        int playfullness);
        ...
        List<DogEntity> dogStyle(int size, int apartmentLiving, int noviceOwners, int amountOfShedding,
                        int intelligence,
        ...
        List<DogEntity> dogStyle(int size, int apartmentLiving, int amountOfShedding, int energyLevel,
                        int playfullness);
