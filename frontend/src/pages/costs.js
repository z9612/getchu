...
const Costs = () => {
  ...
  const dogData = {
    그레이하운드: {
      ...
      history:
        "매우 역사가 오래 된 견종으로 기원전 약 3,000년전부터 존재하였던 것으로 여겨진다. 고대 이집트 왕조의 묘석에 이 견종을 연상시키는 것이 남아 있다. 또한 기원전 100년경 그리스 문헌에 의하면 거의 현재의 모습과 다르지 않았던 것을 알 수 있으며 매우 오래 된 역사를 가지고 있음을 증명하고 있다. 사슴 사냥 등의 수렵에 이용하였다.\n16세기에 들어와 영국에서 토끼 쫓기의 경기가 시작되었고 이 견종이 사용되었다. 이것이 현재의 독 레이스가 되었고 그 후 독 레이스(개 경주)는 영국과 미국, 동남아시아 등지에서도 실시되었다. 견종명은 그리스를 의미하는 그리크에서 왔다고 하며 일찍이 이 견종의 모색이 그레이가 많았기에 이름 지어졌다고도 한다.",
      personality:
        "경이로운 스태미나와 내구성을 소유하고 있다. 이해력이 빠르며 우아하고 애정이 풍부하다. 변덕스럽지 않다.",
      weight_min: 22,
      weight_max: 38,
      height_min: 63,
      height_max: 76,
      ...
      image:
        "https://www.dogtime.com/assets/uploads/2011/01/file_23024_greyhound-300x189.jpg",
      mbti: "INTP",
    },
    ...
    도베르만: {
      ...
      image:
        "https://www.dogtime.com/assets/uploads/2011/01/file_22920_doberman-pinscher-300x189.jpg",
      mbti: "ENTJ",
    },
  };
