...
const MedicalCosts = (props) => {
  ...
  return (
    <Box
      ...
      py={1}
    >
      <div className="cost-title">의료비용</div>
      <div>
        <img
          className="cost-img"
          src="https://images.squarespace-cdn.com/content/v1/5aa0bf73af2096458586fb17/1547932498065-AUGFM6FAS19VW32LMSHR/MPC_Dog_Vaccine_Main.jpg?format=1000w"
          alt="dog-vaccine"
        />
      </div>
